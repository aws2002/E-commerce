...
export default function ProductScreen(props) {
                ...
                <div className=" grid grid-cols-2 my-4">
                  ...
                  <div className=" col-span-1">
                    <h2 className=" text-2xl text-slate-400">
                      Color:
                      <span className=" font-bold text-color_1">White</span>{" "}
                    </h2>
                  </div>
                  ...
                  <div className=" col-span-1">
                    <div className=" grid-cols-12 grid mt-3 gap-x-2">
                      ...
                      <div className=" col-span-10 bg-slate-100 text-slate-600 transition-all hover:bg-main hover:text-white text-center py-2 rounded">
                        <button
  ...
  return (
    <>
      ...
      {!productDetails &&  <SkeletonProductItem />}
      <section className="Technical--Details my-32 container">
        <div className=" my-5">
          <h5 className=" text-2xl">Specification</h5>
        </div>
      ...
      <section className="reviews container">
        <div className=" my-5">
          <h5 className=" text-2xl">Reviews</h5>
        </div>
        <div className="  border p-8">
